export default function AboutProject() {
  return (
    <section className="about-project" id="about-project">
      <h2 className="text text_narrow heading">О проекте</h2>
      ...
      <div className="about-project__features">
        <div className="about-project__feature">
          ...
          <p className="text about-project__feature-description">Составление плана, работу над бэкендом, вёрстку,
                                                                 добавление функциональности и финальные доработки.</p>
        </div>
        <div className="about-project__feature">
          <h3 className="text text_narrow about-project__feature-heading">На выполнение диплома ушло 5 недель</h3>
          <p className="text about-project__feature-description">У каждого этапа был мягкий и жёсткий дедлайн,
